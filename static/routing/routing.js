(function () {
  ...
  function draw(data) {
    ...
    data.routes.forEach(function (route, index) {
      ...
      var html = '<article class="routing-result" style="border-left-color:' + color + '"><header><strong>Route ' + route.route_number + '</strong> · ' + route.stop_count + ' stops <button type="button" class="routing-route-optimize" data-route-id="' + route.id + '">Optimize this route</button></header><ol>';
