...
urlpatterns = [
    ...
    path("opportunities/<int:search_id>/", views.ai_search_detail, name="opportunity_detail"),
    path("ai-search/", views.ai_search, name="opportunity_ai_search"),
    path("my-searches/", views.my_searches, name="opportunity_my_searches"),
    ...
    path("ai-search/<int:search_id>/delete/", views.delete_ai_search, name="opportunity_ai_search_delete"),
    ...
    path("data-sources/", views.data_sources, name="opportunity_data_sources"),
    path("parcels/<str:parcel_number>/", views.parcel, name="opportunity_parcel_detail"),
    path("parcels/<str:parcel_number>/gis/live/", views.parcel_live_gis, name="opportunity_parcel_live_gis"),
